        ...
        <div class="col-md-8">
            ...
            <div class="media">
                <div class="media-left media-top">
                    ...
                    <p>
                        <br>
                        Tanggal Upload: <?php echo date('Y-m-d',strtotime($post['created_at'])); ?>
                    </p>
                </div>
            ...
            if(!isset($_GET['tag'])){
                ...
                if($page>1){
                    ...
                    $pageLink.="<a class='page-link'href='index.php?page=1'>Kembali</a>";
                ...
                if($page<=$totalPages){
                    ...
                    $pageLink.="<a class='page-link'href='index.php?page=".$totalPages."'>Next</a>";
                }
