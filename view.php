...
<div class="container">
    ...
    <br>
    <h4>Komentar(<?php echo $comment->countComments($_GET['slug']); ?>)</h4>
    <?php
    if(isset($_POST['btnComment'])){
        ...
        if(!empty($_POST['name'])&&!empty($_POST['email'])&&!empty($_POST['description'])){
            ...
            if($result==true){
                echo"Komentar sudah ditambahkan!";
            }

        }else{
            echo"Masukkan nama / email / deskripsi";
        }
    }
    ?>
    ...
    <form action="" method="POST">
        <div class="col-md-4">
            ...
            <div class="form-group">
                <button type="submit" name="btnComment" class="btn btn-outline-success">Kirim</button>
            </div>
        </div>
